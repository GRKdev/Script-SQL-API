...
from utils.functions_stats import generate_random_prompts, generate_url_query
...
class StatsTab:
    ...
    def create_gui(self):
        ...
        self.query_type = ttk.Combobox(self.frame, values=["Fact_anuales", "Fact_CurrentYear", "Fact_SelectedYear", "Fact_CombinedYears"], state="readonly")
        self.query_type.grid(row=1, column=1, pady=(10, 10))
        self.query_type.set("Fact_anuales") 
